  ...
  return (
    <>
      ...
      <section id="support" className="px-4 md:px-8 2xl:px-0">
        <div className="relative mx-auto max-w-c-1390 px-7.5 pt-5 lg:px-15 lg:pt-10 xl:px-20 xl:pt-15">
          {/* <!-- Section Title Start --> */}
          <SectionHeader
            headerInfo={{
              title: "Contact Us",
              subtitle: "Start Using Software Made for Shoppers",
              description: `Explore Kassapos without paying a single rupee. Book Your Free Demo in Just 15 Seconds.`,
            }}
          />
          {/* <!-- Section Title End --> */}
          <div className="mt-10">
            ...
            <div className="flex flex-col-reverse flex-wrap gap-8 md:flex-row md:flex-nowrap md:justify-between xl:gap-20">
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-4 xl:justify-between ">
                    <div className="mb-4 flex md:mb-0">
                      ...
                      />
                      <span className="border-gray-300 bg-gray-100 text-blue-600 dark:border-gray-600 dark:bg-gray-700 group mt-2 flex h-5 min-w-[20px] items-center justify-center rounded-sm peer-checked:bg-[#1660c1]">
                        <svg
              ...
              >               
                <div className="5 mb-7">
                  ...
                  <p>No.4/479,VOC Street, Anbu Nagar, Madurai – 625020</p>
                </div>
                <div className="5 mb-7">
                  <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
                    Email Address
